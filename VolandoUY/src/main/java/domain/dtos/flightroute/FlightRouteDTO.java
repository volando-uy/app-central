...
public class FlightRouteDTO extends BaseFlightRouteDTO {
    ...
    public FlightRouteDTO(String name, String description, LocalDate createdAt, Double priceTouristClass, Double priceBusinessClass, Double priceExtraUnitBaggage, EnumEstatusRuta status, String image, String videoURL, Double visitCount) {
