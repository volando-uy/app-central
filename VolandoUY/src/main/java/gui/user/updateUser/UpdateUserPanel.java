...
public class UpdateUserPanel extends JPanel {
        ...
        loadUserBtn.addActionListener(e -> {
            ...
            if (selectedNickname != null) {
                ...
                if (selectedUser instanceof AirlineDTO selectedUser) {
                    ...
                    variableTextField4.setText(selectedUser.getBirthDate().toString());
    ...
    private void initComponents() {
        ...
        //======== updateBtnPanel ========
        {
            ...
            //---- updateUserBtn ----
            updateUserBtn.setText("Modificar cliente");
            updateUserBtn.setMargin(new Insets(0, 50, 0, 50));
        ...
        //---- vSpacer19 ----
        vSpacer19.setPreferredSize(new Dimension(10, 200));
