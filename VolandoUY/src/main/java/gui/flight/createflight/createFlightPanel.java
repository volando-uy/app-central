...
public class createFlightPanel extends JPanel {
    ...
    private AirlineDTO selectedAirline;
    ...
    private void loadFlightRouteList(String airlineNickname) {
        ...
        if (flightRoutes != null) {
            for (FlightRouteDTO fr : flightRoutes) {
                Object[] rowData = {
                        evadeNullString(fr.getName()),
                        evadeNullString(fr.getDescription()),
                        evadeNullString(fr.getOriginAeroCode()),
                        evadeNullString(fr.getDestinationAeroCode()),
    ...
    private String evadeNullString(String s) {
        return (s == null) ? "" : s;
    }
