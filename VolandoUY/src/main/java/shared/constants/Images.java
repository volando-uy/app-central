...
public class Images {
    ...
    public static final String FLIGHTS_PATH = "flights" + File.separator;
    public static final String FLIGHT_ROUTES_PATH = "flight_routes" + File.separator;
    public static final String FLIGHT_ROUTES_PACKAGES_PATH = "flight_route_packages" + File.separator;
